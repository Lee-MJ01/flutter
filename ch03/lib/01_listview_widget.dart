  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        home: Scaffold(
          ...
          // ListView.builder는 아이템 개수가 많거나 동적으로 위젯을 생성해서 메모리 자원을 효율적으로 사용, Lazy Loading으로 성능 극대화
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        home: Scaffold(
          ...
          // ListView.separated는 ListView.builder에서 목록 구분선을 커스텀 할 수 있게 만든 위젯
