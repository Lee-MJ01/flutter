...
class MyApp extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('03.상태 생명 주기 위젯 실습'),
        ),
        body: ParentWidget(),
      ),
    );
    ...
    return Column(
      children: [
        ...
        ElevatedButton(
          ...
          child: const Text('ChildeWidget 상태 변경')
        ),
        ElevatedButton(
            onPressed: _toggleChild,
            child: const Text('ChildeWidget 생성/제거')
        )
      ],
    );
  }
...
class _ChildWidgetState extends State<ChildWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      color: Colors.blue,
      child: Text('ChildWidget count : ${widget.count}', style: TextStyle(fontSize: 26),),
    );
  }
